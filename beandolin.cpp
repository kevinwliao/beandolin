...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "june5filtered.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst2 = std::exp(0.0f - 166.66667f / fConst0);
		fConst3 = std::exp(0.0f - 83.333336f / fConst0);
		float fConst4 = std::tan(7853.9814f / fConst0);
		fConst5 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst4));
		float fConst6 = 1.0f / fConst4;
		fConst7 = 1.0f - (1.0f - fConst6) / fConst4;
		fConst8 = 1.0f / ((fConst6 + 1.0f) / fConst4 + 1.0f);
		fConst9 = 44.1f / fConst0;
		fConst10 = 1.0f - fConst9;
		fConst11 = 19404.0f / fConst0;
		fConst12 = 1.0f / fConst0;
		fConst13 = 0.00882353f * fConst0;
		fConst14 = 0.00073529413f * fConst0;
		fConst15 = 1.0f - fConst3;
		fConst16 = 1.0f - fConst2;
		fConst17 = std::exp(0.0f - 2.0f / fConst0);
		fConst18 = std::exp(0.0f - 1.25e+03f / fConst0);
		fConst19 = 1.0f - fConst1;
	}
	
	virtual void instanceResetUserInterface() {
		fHslider0 = FAUSTFLOAT(62.0f);
		fHslider1 = FAUSTFLOAT(0.1f);
		fHslider2 = FAUSTFLOAT(0.1f);
		fHslider3 = FAUSTFLOAT(74.0f);
		fHslider4 = FAUSTFLOAT(69.0f);
		fHslider5 = FAUSTFLOAT(66.0f);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("june5filtered");
		ui_interface->addHorizontalSlider("bassGain1", &fHslider2, FAUSTFLOAT(0.1f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("bassGain2", &fHslider1, FAUSTFLOAT(0.1f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("midi1", &fHslider0, FAUSTFLOAT(62.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(127.0f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("midi2", &fHslider5, FAUSTFLOAT(66.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(127.0f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("midi3", &fHslider4, FAUSTFLOAT(69.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(127.0f), FAUSTFLOAT(1.0f));
		ui_interface->addHorizontalSlider("midi4", &fHslider3, FAUSTFLOAT(74.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(127.0f), FAUSTFLOAT(1.0f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow0 = fConst11 * std::pow(2.0f, 0.083333336f * (float(fHslider0) + -69.0f));
		float fSlow1 = fConst9 * float(fHslider1);
		float fSlow2 = fConst9 * float(fHslider2);
		float fSlow3 = fConst11 * std::pow(2.0f, 0.083333336f * (float(fHslider3) + -69.0f));
		float fSlow4 = fConst11 * std::pow(2.0f, 0.083333336f * (float(fHslider4) + -69.0f));
		float fSlow5 = fConst11 * std::pow(2.0f, 0.083333336f * (float(fHslider5) + -69.0f));
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			fRec7[0] = fSlow0 + fConst10 * fRec7[1];
			float fTemp0 = std::max<float>(1.1920929e-07f, std::fabs(0.18375f * fRec7[0]));
			float fTemp1 = fRec5[1] + fConst12 * fTemp0;
			...
			fRec8[0] = fSlow1 + fConst10 * fRec8[1];
			fRec4[0] = fRec8[0] * (2.0f * fRec6 + -1.0f) - fConst8 * (fConst7 * fRec4[2] + fConst5 * fRec4[1]);
			float fTemp4 = std::max<float>(1.1920929e-07f, std::fabs(0.245f * fRec7[0]));
			float fTemp5 = fRec10[1] + fConst12 * fTemp4;
			float fTemp6 = fTemp5 + -1.0f;
			int iTemp7 = fTemp6 < 0.0f;
			fRec10[0] = ((iTemp7) ? fTemp5 : fTemp6);
			float fRec11 = ((iTemp7) ? fTemp5 : fTemp5 + fTemp6 * (1.0f - fConst0 / fTemp4));
			fRec12[0] = fSlow2 + fConst10 * fRec12[1];
			fRec9[0] = fRec12[0] * (2.0f * fRec11 + -1.0f) - fConst8 * (fConst7 * fRec9[2] + fConst5 * fRec9[1]);
			iRec23[0] = 0;
			int iRec24 = iRec23[1];
			float fRec27 = float(iRec19[1]) - 0.9978437f * (0.7f * fRec28[2] + 0.15f * (fRec28[1] + fRec28[3]));
			fRec38[0] = fSlow3 + fConst10 * fRec38[1];
			float fTemp8 = fConst14 * (3.4e+02f / fRec38[0] + -0.1f);
			float fTemp9 = fTemp8 + -1.499995f;
			int iTemp10 = int(fTemp9);
			int iTemp11 = int(std::min<float>(fConst13, float(std::max<int>(0, iTemp10 + 4))));
			int iTemp12 = iTemp11 + 1;
			float fTemp13 = std::floor(fTemp9);
			float fTemp14 = fTemp8 + (-3.0f - fTemp13);
			float fTemp15 = fTemp8 + (-2.0f - fTemp13);
			float fTemp16 = fTemp8 + (-1.0f - fTemp13);
			float fTemp17 = fTemp16 * fTemp15;
			float fTemp18 = fTemp17 * fTemp14;
			float fTemp19 = fTemp8 + (-4.0f - fTemp13);
			float fTemp20 = 0.0f - fTemp19;
			int iTemp21 = int(std::min<float>(fConst13, float(std::max<int>(0, iTemp10 + 3))));
			int iTemp22 = iTemp21 + 1;
			float fTemp23 = 0.0f - 0.5f * fTemp19;
			float fTemp24 = 0.0f - fTemp14;
			int iTemp25 = int(std::min<float>(fConst13, float(std::max<int>(0, iTemp10 + 2))));
			int iTemp26 = iTemp25 + 1;
			float fTemp27 = 0.0f - 0.33333334f * fTemp19;
			float fTemp28 = 0.0f - 0.5f * fTemp14;
			float fTemp29 = 0.0f - fTemp15;
			int iTemp30 = int(std::min<float>(fConst13, float(std::max<int>(0, iTemp10 + 1))));
			int iTemp31 = iTemp30 + 1;
			float fTemp32 = fTemp8 - fTemp13;
			float fTemp33 = 0.0f - 0.25f * fTemp19;
			float fTemp34 = 0.0f - 0.33333334f * fTemp14;
			float fTemp35 = 0.0f - 0.5f * fTemp15;
			float fTemp36 = 0.0f - fTemp16;
			int iTemp37 = int(std::min<float>(fConst13, float(std::max<int>(0, iTemp10))));
			int iTemp38 = iTemp37 + 1;
			fRec35[0] = fRec15[(IOTA0 - iTemp38) & 2047] * fTemp36 * fTemp35 * fTemp34 * fTemp33 + fTemp32 * (fRec15[(IOTA0 - iTemp31) & 2047] * fTemp29 * fTemp28 * fTemp27 + 0.5f * fTemp16 * fRec15[(IOTA0 - iTemp26) & 2047] * fTemp24 * fTemp23 + 0.16666667f * fTemp17 * fRec15[(IOTA0 - iTemp22) & 2047] * fTemp20 + 0.041666668f * fTemp18 * fRec15[(IOTA0 - iTemp12) & 2047]);
			fRec39[0] = 0.95f * fRec35[1] + 0.05f * fRec39[1];
			float fRec36 = fRec39[0];
			fRec41[0] = fRec13[1];
			fRec42[IOTA0 & 2047] = -1.0f * 0.9978437f * (0.7f * fRec41[2] + 0.15f * (fRec41[1] + fRec41[3]));
			float fTemp39 = fTemp17 * fTemp20;
			float fTemp40 = fTemp16 * fTemp24 * fTemp23;
			float fTemp41 = fTemp29 * fTemp28 * fTemp27;
			float fTemp42 = fTemp36 * fTemp35 * fTemp34 * fTemp33;
			fVec0[0] = fTemp42 * fRec42[(IOTA0 - (iTemp37 + 2)) & 2047] + fTemp32 * (fTemp41 * fRec42[(IOTA0 - (iTemp30 + 2)) & 2047] + 0.5f * fTemp40 * fRec42[(IOTA0 - (iTemp25 + 2)) & 2047] + 0.16666667f * fTemp39 * fRec42[(IOTA0 - (iTemp21 + 2)) & 2047] + 0.041666668f * fTemp18 * fRec42[(IOTA0 - (iTemp11 + 2)) & 2047]);
			float fTemp43 = 0.25f * float(input0[i0]);
			fVec1[0] = fTemp43 + fVec0[1];
			fRec40[IOTA0 & 2047] = 0.95f * fVec1[1] + 0.05f * fRec40[(IOTA0 - 1) & 2047];
			float fRec37 = fTemp42 * fRec40[(IOTA0 - iTemp37) & 2047] + fTemp32 * (fTemp41 * fRec40[(IOTA0 - iTemp30) & 2047] + 0.5f * fTemp40 * fRec40[(IOTA0 - iTemp25) & 2047] + 0.16666667f * fTemp39 * fRec40[(IOTA0 - iTemp21) & 2047] + 0.041666668f * fTemp18 * fRec40[(IOTA0 - iTemp11) & 2047]);
			fRec32[0] = fRec36;
			float fRec33 = fTemp43 + fRec32[1];
			float fRec34 = fRec37;
			fRec29[IOTA0 & 2047] = fRec33;
			float fRec30 = fTemp42 * fRec29[(IOTA0 - iTemp38) & 2047] + fTemp32 * (fTemp41 * fRec29[(IOTA0 - iTemp31) & 2047] + 0.5f * fTemp40 * fRec29[(IOTA0 - iTemp26) & 2047] + 0.16666667f * fTemp39 * fRec29[(IOTA0 - iTemp22) & 2047] + 0.041666668f * fTemp18 * fRec29[(IOTA0 - iTemp12) & 2047]);
			fRec31[0] = fRec34;
			fRec28[0] = fRec31[1];
			float fRec25 = fRec28[1];
			float fRec26 = fRec28[1];
			iRec19[0] = iRec24;
			float fRec20 = fRec27;
			float fRec21 = fRec25;
			float fRec22 = fRec26;
			fRec15[IOTA0 & 2047] = fRec20;
			float fRec16 = fRec30;
			float fRec17 = fRec21;
			float fRec18 = fRec22;
			fRec13[0] = fRec16;
			...
			iRec53[0] = 0;
			int iRec54 = iRec53[1];
			float fRec57 = float(iRec49[1]) - 0.9978437f * (0.7f * fRec58[2] + 0.15f * (fRec58[1] + fRec58[3]));
			fRec68[0] = fSlow4 + fConst10 * fRec68[1];
			float fTemp44 = fConst14 * (3.4e+02f / fRec68[0] + -0.1f);
			float fTemp45 = fTemp44 + -1.499995f;
			int iTemp46 = int(fTemp45);
			int iTemp47 = int(std::min<float>(fConst13, float(std::max<int>(0, iTemp46 + 4))));
			int iTemp48 = iTemp47 + 1;
			float fTemp49 = std::floor(fTemp45);
			float fTemp50 = fTemp44 + (-3.0f - fTemp49);
			float fTemp51 = fTemp44 + (-2.0f - fTemp49);
			float fTemp52 = fTemp44 + (-1.0f - fTemp49);
			float fTemp53 = fTemp52 * fTemp51;
			float fTemp54 = fTemp53 * fTemp50;
			float fTemp55 = fTemp44 + (-4.0f - fTemp49);
			float fTemp56 = 0.0f - fTemp55;
			int iTemp57 = int(std::min<float>(fConst13, float(std::max<int>(0, iTemp46 + 3))));
			int iTemp58 = iTemp57 + 1;
			float fTemp59 = 0.0f - 0.5f * fTemp55;
			float fTemp60 = 0.0f - fTemp50;
			int iTemp61 = int(std::min<float>(fConst13, float(std::max<int>(0, iTemp46 + 2))));
			int iTemp62 = iTemp61 + 1;
			float fTemp63 = 0.0f - 0.33333334f * fTemp55;
			float fTemp64 = 0.0f - 0.5f * fTemp50;
			float fTemp65 = 0.0f - fTemp51;
			int iTemp66 = int(std::min<float>(fConst13, float(std::max<int>(0, iTemp46 + 1))));
			int iTemp67 = iTemp66 + 1;
			float fTemp68 = fTemp44 - fTemp49;
			float fTemp69 = 0.0f - 0.25f * fTemp55;
			float fTemp70 = 0.0f - 0.33333334f * fTemp50;
			float fTemp71 = 0.0f - 0.5f * fTemp51;
			float fTemp72 = 0.0f - fTemp52;
			int iTemp73 = int(std::min<float>(fConst13, float(std::max<int>(0, iTemp46))));
			int iTemp74 = iTemp73 + 1;
			fRec65[0] = fRec45[(IOTA0 - iTemp74) & 2047] * fTemp72 * fTemp71 * fTemp70 * fTemp69 + fTemp68 * (fRec45[(IOTA0 - iTemp67) & 2047] * fTemp65 * fTemp64 * fTemp63 + 0.5f * fTemp52 * fRec45[(IOTA0 - iTemp62) & 2047] * fTemp60 * fTemp59 + 0.16666667f * fTemp53 * fRec45[(IOTA0 - iTemp58) & 2047] * fTemp56 + 0.041666668f * fTemp54 * fRec45[(IOTA0 - iTemp48) & 2047]);
			fRec69[0] = 0.95f * fRec65[1] + 0.05f * fRec69[1];
			float fRec66 = fRec69[0];
			fRec71[0] = fRec43[1];
			fRec72[IOTA0 & 2047] = -1.0f * 0.9978437f * (0.7f * fRec71[2] + 0.15f * (fRec71[1] + fRec71[3]));
			float fTemp75 = fTemp53 * fTemp56;
			float fTemp76 = fTemp52 * fTemp60 * fTemp59;
			float fTemp77 = fTemp65 * fTemp64 * fTemp63;
			float fTemp78 = fTemp72 * fTemp71 * fTemp70 * fTemp69;
			fVec2[0] = fTemp78 * fRec72[(IOTA0 - (iTemp73 + 2)) & 2047] + fTemp68 * (fTemp77 * fRec72[(IOTA0 - (iTemp66 + 2)) & 2047] + 0.5f * fTemp76 * fRec72[(IOTA0 - (iTemp61 + 2)) & 2047] + 0.16666667f * fTemp75 * fRec72[(IOTA0 - (iTemp57 + 2)) & 2047] + 0.041666668f * fTemp54 * fRec72[(IOTA0 - (iTemp47 + 2)) & 2047]);
			fVec3[0] = fTemp43 + fVec2[1];
			fRec70[IOTA0 & 2047] = 0.95f * fVec3[1] + 0.05f * fRec70[(IOTA0 - 1) & 2047];
			float fRec67 = fTemp78 * fRec70[(IOTA0 - iTemp73) & 2047] + fTemp68 * (fTemp77 * fRec70[(IOTA0 - iTemp66) & 2047] + 0.5f * fTemp76 * fRec70[(IOTA0 - iTemp61) & 2047] + 0.16666667f * fTemp75 * fRec70[(IOTA0 - iTemp57) & 2047] + 0.041666668f * fTemp54 * fRec70[(IOTA0 - iTemp47) & 2047]);
			fRec62[0] = fRec66;
			float fRec63 = fTemp43 + fRec62[1];
			float fRec64 = fRec67;
			fRec59[IOTA0 & 2047] = fRec63;
			float fRec60 = fTemp78 * fRec59[(IOTA0 - iTemp74) & 2047] + fTemp68 * (fTemp77 * fRec59[(IOTA0 - iTemp67) & 2047] + 0.5f * fTemp76 * fRec59[(IOTA0 - iTemp62) & 2047] + 0.16666667f * fTemp75 * fRec59[(IOTA0 - iTemp58) & 2047] + 0.041666668f * fTemp54 * fRec59[(IOTA0 - iTemp48) & 2047]);
			fRec61[0] = fRec64;
			fRec58[0] = fRec61[1];
			float fRec55 = fRec58[1];
			float fRec56 = fRec58[1];
			iRec49[0] = iRec54;
			float fRec50 = fRec57;
			float fRec51 = fRec55;
			float fRec52 = fRec56;
			fRec45[IOTA0 & 2047] = fRec50;
			float fRec46 = fRec60;
			float fRec47 = fRec51;
			float fRec48 = fRec52;
			fRec43[0] = fRec46;
			...
			iRec83[0] = 0;
			int iRec84 = iRec83[1];
			float fRec87 = float(iRec79[1]) - 0.9978437f * (0.7f * fRec88[2] + 0.15f * (fRec88[1] + fRec88[3]));
			fRec98[0] = fSlow5 + fConst10 * fRec98[1];
			float fTemp79 = fConst14 * (3.4e+02f / fRec98[0] + -0.1f);
			float fTemp80 = fTemp79 + -1.499995f;
			int iTemp81 = int(fTemp80);
			int iTemp82 = int(std::min<float>(fConst13, float(std::max<int>(0, iTemp81 + 4))));
			int iTemp83 = iTemp82 + 1;
			float fTemp84 = std::floor(fTemp80);
			float fTemp85 = fTemp79 + (-3.0f - fTemp84);
			float fTemp86 = fTemp79 + (-2.0f - fTemp84);
			float fTemp87 = fTemp79 + (-1.0f - fTemp84);
			float fTemp88 = fTemp87 * fTemp86;
			float fTemp89 = fTemp88 * fTemp85;
			float fTemp90 = fTemp79 + (-4.0f - fTemp84);
			float fTemp91 = 0.0f - fTemp90;
			int iTemp92 = int(std::min<float>(fConst13, float(std::max<int>(0, iTemp81 + 3))));
			int iTemp93 = iTemp92 + 1;
			float fTemp94 = 0.0f - 0.5f * fTemp90;
			float fTemp95 = 0.0f - fTemp85;
			int iTemp96 = int(std::min<float>(fConst13, float(std::max<int>(0, iTemp81 + 2))));
			int iTemp97 = iTemp96 + 1;
			float fTemp98 = 0.0f - 0.33333334f * fTemp90;
			float fTemp99 = 0.0f - 0.5f * fTemp85;
			float fTemp100 = 0.0f - fTemp86;
			int iTemp101 = int(std::min<float>(fConst13, float(std::max<int>(0, iTemp81 + 1))));
			int iTemp102 = iTemp101 + 1;
			float fTemp103 = fTemp79 - fTemp84;
			float fTemp104 = 0.0f - 0.25f * fTemp90;
			float fTemp105 = 0.0f - 0.33333334f * fTemp85;
			float fTemp106 = 0.0f - 0.5f * fTemp86;
			float fTemp107 = 0.0f - fTemp87;
			int iTemp108 = int(std::min<float>(fConst13, float(std::max<int>(0, iTemp81))));
			int iTemp109 = iTemp108 + 1;
			fRec95[0] = fRec75[(IOTA0 - iTemp109) & 2047] * fTemp107 * fTemp106 * fTemp105 * fTemp104 + fTemp103 * (fRec75[(IOTA0 - iTemp102) & 2047] * fTemp100 * fTemp99 * fTemp98 + 0.5f * fTemp87 * fRec75[(IOTA0 - iTemp97) & 2047] * fTemp95 * fTemp94 + 0.16666667f * fTemp88 * fRec75[(IOTA0 - iTemp93) & 2047] * fTemp91 + 0.041666668f * fTemp89 * fRec75[(IOTA0 - iTemp83) & 2047]);
			fRec99[0] = 0.95f * fRec95[1] + 0.05f * fRec99[1];
			float fRec96 = fRec99[0];
			fRec101[0] = fRec73[1];
			fRec102[IOTA0 & 2047] = -1.0f * 0.9978437f * (0.7f * fRec101[2] + 0.15f * (fRec101[1] + fRec101[3]));
			float fTemp110 = fTemp88 * fTemp91;
			float fTemp111 = fTemp87 * fTemp95 * fTemp94;
			float fTemp112 = fTemp100 * fTemp99 * fTemp98;
			float fTemp113 = fTemp107 * fTemp106 * fTemp105 * fTemp104;
			fVec4[0] = fTemp113 * fRec102[(IOTA0 - (iTemp108 + 2)) & 2047] + fTemp103 * (fTemp112 * fRec102[(IOTA0 - (iTemp101 + 2)) & 2047] + 0.5f * fTemp111 * fRec102[(IOTA0 - (iTemp96 + 2)) & 2047] + 0.16666667f * fTemp110 * fRec102[(IOTA0 - (iTemp92 + 2)) & 2047] + 0.041666668f * fTemp89 * fRec102[(IOTA0 - (iTemp82 + 2)) & 2047]);
			fVec5[0] = fTemp43 + fVec4[1];
			fRec100[IOTA0 & 2047] = 0.95f * fVec5[1] + 0.05f * fRec100[(IOTA0 - 1) & 2047];
			float fRec97 = fTemp113 * fRec100[(IOTA0 - iTemp108) & 2047] + fTemp103 * (fTemp112 * fRec100[(IOTA0 - iTemp101) & 2047] + 0.5f * fTemp111 * fRec100[(IOTA0 - iTemp96) & 2047] + 0.16666667f * fTemp110 * fRec100[(IOTA0 - iTemp92) & 2047] + 0.041666668f * fTemp89 * fRec100[(IOTA0 - iTemp82) & 2047]);
			fRec92[0] = fRec96;
			float fRec93 = fTemp43 + fRec92[1];
			float fRec94 = fRec97;
			fRec89[IOTA0 & 2047] = fRec93;
			float fRec90 = fTemp113 * fRec89[(IOTA0 - iTemp109) & 2047] + fTemp103 * (fTemp112 * fRec89[(IOTA0 - iTemp102) & 2047] + 0.5f * fTemp111 * fRec89[(IOTA0 - iTemp97) & 2047] + 0.16666667f * fTemp110 * fRec89[(IOTA0 - iTemp93) & 2047] + 0.041666668f * fTemp89 * fRec89[(IOTA0 - iTemp83) & 2047]);
			fRec91[0] = fRec94;
			fRec88[0] = fRec91[1];
			float fRec85 = fRec88[1];
			float fRec86 = fRec88[1];
			iRec79[0] = iRec84;
			float fRec80 = fRec87;
			float fRec81 = fRec85;
			float fRec82 = fRec86;
			fRec75[IOTA0 & 2047] = fRec80;
			float fRec76 = fRec90;
			float fRec77 = fRec81;
			float fRec78 = fRec82;
			fRec73[0] = fRec76;
			float fRec74 = fRec78;
			iRec113[0] = 0;
			int iRec114 = iRec113[1];
			float fRec117 = float(iRec109[1]) - 0.9978437f * (0.7f * fRec118[2] + 0.15f * (fRec118[1] + fRec118[3]));
			float fTemp114 = fConst14 * (3.4e+02f / fRec7[0] + -0.1f);
			float fTemp115 = fTemp114 + -1.499995f;
			int iTemp116 = int(fTemp115);
			int iTemp117 = int(std::min<float>(fConst13, float(std::max<int>(0, iTemp116 + 4))));
			int iTemp118 = iTemp117 + 1;
			float fTemp119 = std::floor(fTemp115);
			float fTemp120 = fTemp114 + (-3.0f - fTemp119);
			float fTemp121 = fTemp114 + (-2.0f - fTemp119);
			float fTemp122 = fTemp114 + (-1.0f - fTemp119);
			float fTemp123 = fTemp122 * fTemp121;
			float fTemp124 = fTemp123 * fTemp120;
			float fTemp125 = fTemp114 + (-4.0f - fTemp119);
			float fTemp126 = 0.0f - fTemp125;
			int iTemp127 = int(std::min<float>(fConst13, float(std::max<int>(0, iTemp116 + 3))));
			int iTemp128 = iTemp127 + 1;
			float fTemp129 = 0.0f - 0.5f * fTemp125;
			float fTemp130 = 0.0f - fTemp120;
			int iTemp131 = int(std::min<float>(fConst13, float(std::max<int>(0, iTemp116 + 2))));
			int iTemp132 = iTemp131 + 1;
			float fTemp133 = 0.0f - 0.33333334f * fTemp125;
			float fTemp134 = 0.0f - 0.5f * fTemp120;
			float fTemp135 = 0.0f - fTemp121;
			int iTemp136 = int(std::min<float>(fConst13, float(std::max<int>(0, iTemp116 + 1))));
			int iTemp137 = iTemp136 + 1;
			float fTemp138 = fTemp114 - fTemp119;
			float fTemp139 = 0.0f - 0.25f * fTemp125;
			float fTemp140 = 0.0f - 0.33333334f * fTemp120;
			float fTemp141 = 0.0f - 0.5f * fTemp121;
			float fTemp142 = 0.0f - fTemp122;
			int iTemp143 = int(std::min<float>(fConst13, float(std::max<int>(0, iTemp116))));
			int iTemp144 = iTemp143 + 1;
			fRec125[0] = fRec105[(IOTA0 - iTemp144) & 2047] * fTemp142 * fTemp141 * fTemp140 * fTemp139 + fTemp138 * (fRec105[(IOTA0 - iTemp137) & 2047] * fTemp135 * fTemp134 * fTemp133 + 0.5f * fTemp122 * fRec105[(IOTA0 - iTemp132) & 2047] * fTemp130 * fTemp129 + 0.16666667f * fTemp123 * fRec105[(IOTA0 - iTemp128) & 2047] * fTemp126 + 0.041666668f * fTemp124 * fRec105[(IOTA0 - iTemp118) & 2047]);
			fRec128[0] = 0.95f * fRec125[1] + 0.05f * fRec128[1];
			float fRec126 = fRec128[0];
			fRec130[0] = fRec103[1];
			fRec131[IOTA0 & 2047] = -1.0f * 0.9978437f * (0.7f * fRec130[2] + 0.15f * (fRec130[1] + fRec130[3]));
			float fTemp145 = fTemp123 * fTemp126;
			float fTemp146 = fTemp122 * fTemp130 * fTemp129;
			float fTemp147 = fTemp135 * fTemp134 * fTemp133;
			float fTemp148 = fTemp142 * fTemp141 * fTemp140 * fTemp139;
			fVec6[0] = fTemp148 * fRec131[(IOTA0 - (iTemp143 + 2)) & 2047] + fTemp138 * (fTemp147 * fRec131[(IOTA0 - (iTemp136 + 2)) & 2047] + 0.5f * fTemp146 * fRec131[(IOTA0 - (iTemp131 + 2)) & 2047] + 0.16666667f * fTemp145 * fRec131[(IOTA0 - (iTemp127 + 2)) & 2047] + 0.041666668f * fTemp124 * fRec131[(IOTA0 - (iTemp117 + 2)) & 2047]);
			fVec7[0] = fVec6[1] + fTemp43;
			fRec129[IOTA0 & 2047] = 0.95f * fVec7[1] + 0.05f * fRec129[(IOTA0 - 1) & 2047];
			float fRec127 = fTemp148 * fRec129[(IOTA0 - iTemp143) & 2047] + fTemp138 * (fTemp147 * fRec129[(IOTA0 - iTemp136) & 2047] + 0.5f * fTemp146 * fRec129[(IOTA0 - iTemp131) & 2047] + 0.16666667f * fTemp145 * fRec129[(IOTA0 - iTemp127) & 2047] + 0.041666668f * fTemp124 * fRec129[(IOTA0 - iTemp117) & 2047]);
			fRec122[0] = fRec126;
			float fRec123 = fTemp43 + fRec122[1];
			float fRec124 = fRec127;
			fRec119[IOTA0 & 2047] = fRec123;
			float fRec120 = fTemp148 * fRec119[(IOTA0 - iTemp144) & 2047] + fTemp138 * (fTemp147 * fRec119[(IOTA0 - iTemp137) & 2047] + 0.5f * fTemp146 * fRec119[(IOTA0 - iTemp132) & 2047] + 0.16666667f * fTemp145 * fRec119[(IOTA0 - iTemp128) & 2047] + 0.041666668f * fTemp124 * fRec119[(IOTA0 - iTemp118) & 2047]);
			fRec121[0] = fRec124;
			fRec118[0] = fRec121[1];
			float fRec115 = fRec118[1];
			float fRec116 = fRec118[1];
			iRec109[0] = iRec114;
			float fRec110 = fRec117;
			float fRec111 = fRec115;
			float fRec112 = fRec116;
			fRec105[IOTA0 & 2047] = fRec110;
			float fRec106 = fRec120;
			float fRec107 = fRec111;
			float fRec108 = fRec112;
			fRec103[0] = fRec106;
			float fRec104 = fRec108;
			float fTemp149 = fRec104 + fRec74 + fRec44 + fRec14 + fConst8 * (fRec9[2] + fRec9[0] + 2.0f * fRec9[1] + fRec4[2] + fRec4[0] + 2.0f * fRec4[1]);
			fRec3[0] = fConst15 * std::fabs(fTemp149) + fConst3 * fRec3[1];
			fRec2[0] = fConst16 * (0.0f - 0.75f * std::max<float>(2e+01f * (std::log10(std::max<float>(1.1754944e-38f, fRec3[0])) + 1.0f), 0.0f)) + fConst2 * fRec2[1];
			float fTemp150 = fTemp149 * std::pow(1e+01f, 0.05f * fRec2[0]);
			float fTemp151 = std::fabs(fTemp150);
			float fTemp152 = ((fTemp151 > fRec1[1]) ? fConst18 : fConst17);
			fRec1[0] = fTemp151 * (1.0f - fTemp152) + fRec1[1] * fTemp152;
			fRec0[0] = fConst19 * (0.0f - 0.75f * std::max<float>(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fRec1[0])) + 6.0f, 0.0f)) + fConst1 * fRec0[1];
			float fTemp153 = fTemp150 * std::pow(1e+01f, 0.05f * fRec0[0]);
			output0[i0] = FAUSTFLOAT(fTemp153);
			output1[i0] = FAUSTFLOAT(fTemp153);
			fRec7[1] = fRec7[0];
			fRec5[1] = fRec5[0];
			fRec8[1] = fRec8[0];
			fRec4[2] = fRec4[1];
	...
	#define FAUST_FILE_NAME "june5filtered.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("bassGain1", fHslider2, 0.1f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("bassGain2", fHslider1, 0.1f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("midi1", fHslider0, 62.0f, 0.0f, 127.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("midi2", fHslider5, 66.0f, 0.0f, 127.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("midi3", fHslider4, 69.0f, 0.0f, 127.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("midi4", fHslider3, 74.0f, 0.0f, 127.0f, 1.0f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, bassGain1, "bassGain1", fHslider2, 0.1f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, bassGain2, "bassGain2", fHslider1, 0.1f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, midi1, "midi1", fHslider0, 62.0f, 0.0f, 127.0f, 1.0f) \
		p(HORIZONTALSLIDER, midi2, "midi2", fHslider5, 66.0f, 0.0f, 127.0f, 1.0f) \
		p(HORIZONTALSLIDER, midi3, "midi3", fHslider4, 69.0f, 0.0f, 127.0f, 1.0f) \
		p(HORIZONTALSLIDER, midi4, "midi4", fHslider3, 74.0f, 0.0f, 127.0f, 1.0f) \
...
june5filtered::june5filtered() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void june5filtered::updateImp(void)
{
#if MIDICTRL
...
void june5filtered::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void june5filtered::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float june5filtered::getParamValue(const std::string& path)
{
